...
data = dict(
    ...
    train=dict(
        ...
        data_root='/home/MSAI/wzheng014/ACV/data/train/',
        img_dir='train_image/',
        ann_dir='train_mask/',
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    val=dict(
        type='CelebAMaskDataset',
        data_root='/home/MSAI/wzheng014/ACV/data/val/',
        img_dir='val_image/',
        ann_dir='val_mask/',
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    test=dict(
        type='CelebAMaskDataset',
        data_root='/home/MSAI/wzheng014/ACV/data/test/',
        img_dir='test_image',
        # ann_dir='test_mask',
        split='mini_test.txt',
        pipeline=[
...
optimizer = dict(type='SGD', lr=0.0001, momentum=0.0, weight_decay=0.0002)
...
work_dir = "/home/MSAI/wzheng014/finetune/"
gpu_ids = range(0,1)
seed = 0